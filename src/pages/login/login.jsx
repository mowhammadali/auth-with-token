...
export default function Login() {
    ...
    return (
        <div className="w-full h-screen">
            <section
                className="w-80 h-auto border-2 border-slate-700 rounded-2xl mx-auto mt-[100px]
                flex flex-col items-center p-4"
            >
                <h3 className="text-lg font-bold mb-20 select-none">Login</h3>
